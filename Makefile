...
CROSS_COMPILE_ARM32 ?= /home/chanz22/tc/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-
...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
CC		= /home/chanz22/tc/clang-5657785-9.0/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -Wno-format-security \
		   -std=gnu89 $(call cc-option,-fno-PIE) -march=armv8-a	-mtune=cortex-a53 -mcpu=cortex-a53
